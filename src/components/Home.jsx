      ...
      <animated.div style={iconSpring} className="flex flex-col mt-2 space-x-6">
        <div className="flex mt-2 space-x-6">
          <a
            ...
            href={'https://github.com/ShahZaib151214'}
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={'https://www.linkedin.com/in/shah-zaib-kazmi-08914a282'}
            className="text-darkDesert hover:text-goldDesert transition-colors duration-300"
          >
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={'https://media.licdn.com/dms/image/v2/D4D22AQHekbBAE1fNRw/feedshare-shrink_1280/feedshare-shrink_1280/0/1733235630357?e=1738195200&v=beta&t=4vpRheShvQtNUPaGfVdR3xq3HqkCNR5FT7dgVYJkYik'}
            className="text-darkDesert hover:text-goldDesert transition-colors duration-300"
          >
