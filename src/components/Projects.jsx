...
import {project as projects} from "../constants/projects";
    ...
    >
      <div className="relative group">
        ...
        <div className="absolute inset-0 bg-darkDesert bg-opacity-70 flex items-center justify-center rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-all duration-500">
          <h1 className="text-lightDesert text-center text-sm md:text-2xl lg:text-3xl truncate w-11/12 md:w-10/12 font-bold"  style={{backgroundColor:'white', borderRadius:'50px'}}>
            {project.title}
          </h1>
        </div>
